...
<div class="page-content">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-4">
                <form action="{{route('customer_signup_submit')}}" method="post" autocomplete="off">
                    @csrf
                    <div class="login-form">
                        ...
                        <div class="mb-3">
                            <a href="{{route('customer_login')}}" class="primary-color">Already have an account? Login Now</a>
                        </div>
                    </div>
                </form>
            </div>
