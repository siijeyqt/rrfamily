...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form  method="POST" action="{{route('admin_feature_update', $feature_data->id)}}" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="text" class="form-control h_100" cols="30" row="10">{{$feature_data->text}}</textarea>
                                </div>
                                <div class="mb-4">
