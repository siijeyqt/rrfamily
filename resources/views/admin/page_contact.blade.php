...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form  method="POST" action="{{route('admin_page_contact_update')}}" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="contact_map" class="form-control h_100" cols="30" row="10">{{$page_data->contact_map}}</textarea>
                                </div>
                                <div class="mb-4">
