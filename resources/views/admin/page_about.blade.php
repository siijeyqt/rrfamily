...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form  method="POST" action="{{route('admin_page_about_update')}}" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="about_content" class="form-control snote" cols="30" row="10">{{$page_data->about_content}}</textarea>
                                </div>
                                <div class="mb-4">
