                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="short_content" class="form-control h_100" cols="30" row="10">{{old('short_content')}}</textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Content *</label>
                                    <textarea name="content" class="form-control snote" cols="30" row="10">{{old('content')}}</textarea>
                                </div>
                                <div class="mb-4">
