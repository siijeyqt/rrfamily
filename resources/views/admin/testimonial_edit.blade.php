...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form  method="POST" action="{{route('admin_testimonial_update', $testimonial_data->id)}}" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="comment" class="form-control h_100" cols="30" row="10">{{$testimonial_data->comment}}</textarea>
                                </div>
                                <div class="mb-4">
