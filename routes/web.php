...
Route::group(['middleware' => ['admin:admin']], function(){
    ...
    Route::get('/admin/datewise-room', [AdminDatewiseController::class,'index'])->name('admin_datewise_room');
    Route::post('/admin/datewise-room/submit', [AdminDatewiseController::class,'show'])->name('admin_datewise_room_submit');
    ...
    Route::get('/admin/testimonial', [AdminTestimonialController::class,'index'])->name('admin_testimonial_view');
    ...
    Route::get('/admin/room', [AdminRoomController::class,'index'])->name('admin_room_view');
