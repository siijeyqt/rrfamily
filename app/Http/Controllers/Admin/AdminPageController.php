...
class AdminPageController extends Controller
{
    ...
    public function terms_update(Request $request){
        ...
        return redirect()->back()->with('success','Terms and Conditions is updated successfully');
    ...
    public function privacy_update(Request $request){
        ...
        return redirect()->back()->with('success','Privacy Policy page is updated successfully');
